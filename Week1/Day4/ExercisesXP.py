...
describe_city("Rabat", "Morocco") #Rabat is in Morocco.
...
def compare_number(user_number):
    ...
    if user_number == random_number:
        ...
        print(f"you lose! your number: {user_number}, random number: {random_number}")
compare_number(int(input("Enter a number between 1 and 100: ")))
...
def get_random_temp_by_month(month):
...
def main():
    ...
    temperature = get_random_temp_by_month(month)
