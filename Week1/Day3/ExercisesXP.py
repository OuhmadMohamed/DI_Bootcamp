...
total_cost=0
while True:
    name = input("Enter faily numbers name (or type'done' to finish):")
    if name.lower()=="done":
        break
...
print("All keys in the brand dictionary:")
...
users = ["Mickey", "Minnie", "Donald", "Ariel", "Pluto"]
#Expected Results:
#1. Create a dictionary that maps characters to their indices: {"Mickey": 0, "Minnie": 1, "Donald": 2, "Ariel": 3, "Pluto": 4}
char_to_index = {char: index for index, char in enumerate(users)}
print("Character to Index Dictionary:")
print(char_to_index)
#2. Create a dictionary that maps indices to characters: {0: "Mickey", 1: "Minnie", 2: "Donald", 3: "Ariel", 4: "Pluto"}
index_to_char = {index: char for index, char in enumerate(users)}
print("Index to Character Dictionary:")
print(index_to_char)
#3. Create a dictionary where characters are sorted alphabetically and mapped to their indices: {"Ariel": 0, "Donald": 1, "Mickey": 2, "Minnie": 3, "Pluto": 4}
sorted_users = sorted(users)
sorted_char_to_index = {char: index for index, char in enumerate(sorted_users)}
print("Sorted Character to Index Dictionary:")
